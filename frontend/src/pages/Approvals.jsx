        ...
        <div className="grid grid-cols-6 mt-20">
          ...
          <div className="col-span-5 p-5">
            <div>
              ...
              <div className=" mt-5">
                <Link to="/PendingApprovals" style={{ textDecoration: "none" }}>
                ...
                <Link to="/RejectedApprovals" style={{ textDecoration: "none" }}>
                ...
                <Link to="/PreviousApprovals" style={{ textDecoration: "none" }}>
