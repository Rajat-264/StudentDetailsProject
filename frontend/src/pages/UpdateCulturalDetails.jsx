...
<div className="grid grid-cols-6 mt-20">
    ...
    <div className="col-span-5 p-5">
      <div>
        <h1 className='text-2xl font-bold'>Cultural Events Details</h1>
        <div className=" mt-5">
          <div>
              <Input labelText={"Event Name"} placeholderText={"Ragam"} />
          </div>
          <div>
              <Input labelText={"Cultural Event Category"} placeholderText={"Arts"} />
          </div>
